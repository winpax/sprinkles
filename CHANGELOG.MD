...
- Internal: Builds will fail less often by falling back to
...
- Internal: Function for finding running processes
- Internal: Process enum for handling the finding of running processes
